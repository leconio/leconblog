...
from liucl_auth.forms import liuclUserCreationForm, liuclPasswordRestForm
...
class UserControl(View):
    ...
    def forgetpassword(self, request):
        ...
        form = liuclPasswordRestForm(request.POST)
    ...
    def resetpassword(self, request):
        ...
        try:
            ...
            user = liuclUser._default_manager.get(pk=uid)
        except (TypeError, ValueError, OverflowError, liuclUser.DoesNotExist):
            user = None
