...
class liuclUserCreationForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        try:
            liuclUser._default_manager.get(username=username)
        except liuclUser.DoesNotExist:
            return username
    ...
    def clean_email(self):
        ...
        # 判断是这个email 用户是否存在
        try:
            liuclUser._default_manager.get(email=email)
        except liuclUser.DoesNotExist:
            return email
        raise forms.ValidationError(
    ...
    def save(self, commit=True):
        user = super(liuclUserCreationForm, self).save(commit=False)
...
class liuclPasswordRestForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and email:
            try:
                self.user = liuclUser.objects.get(
