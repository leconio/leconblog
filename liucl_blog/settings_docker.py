...
env = {
    'SECRET_KEY': os.environ.get('SECRET_KEY', 'I use liucl'),
    'WEBSITE_TITLE': os.environ.get('WEBSITE_TITLE', u'liucl'),
    'WEBSITE_WELCOME': os.environ.get('WEBSITE_WELCOME', u'欢迎来到liucl'),
    ...
    'EMAIL_SUBJECT_PREFIX': os.environ.get('EMAIL_SUBJECT_PREFIX', u'liucl'),
...
WSGI_APPLICATION = 'liucl_blog.wsgi.application'
...
STATIC_ROOT = '/liucl_blog/static/'

# 设置user model
AUTH_USER_MODEL = "liucl_auth.liuclUser"
